    ...
    return (
      <main className="min-h-screen bg-background dark:bg-background-dark p-6">
        ...
        <p className="text-center text-xs text-text-muted mt-8">
          Ingin absen lewat HP pribadi?{" "}
          <a href="/pegawai/daftar" className="underline font-semibold">
            Daftar akun mandiri
          </a>{" "}
          atau{" "}
          <a href="/pegawai/absen" className="underline font-semibold">
            absen mandiri di sini
          </a>
          .
        </p>
      </main>
