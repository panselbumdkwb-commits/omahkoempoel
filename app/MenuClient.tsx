    ...
    return (
      <main className="min-h-screen flex items-center justify-center bg-wood-grain p-8">
        <div className="max-w-md text-center bg-parchment rounded-lg p-8">
          <h1 className="font-ukir text-2xl text-wood-dark mb-2">{kedaiProfile.name}</h1>
  ...
  return (
    <main className="min-h-screen bg-wood-grain pb-28">
      ...
      <header className="px-6 pt-10 pb-4 text-center">
        ...
        <h1 className="font-ukir text-4xl sm:text-5xl text-parchment mb-1">{kedaiProfile.name}</h1>
        <p className="font-jakarta text-wood-light text-sm italic">{kedaiProfile.tagline}</p>
        <p className="font-jakarta text-wood-light text-sm mt-1">Pilih menu, sentuh untuk memesan</p>
        {showDateTimeClock && (
      ...
      {/* FOOTER — alamat, maps, sosial media */}
      <footer className="px-6 py-8 text-center border-t border-wood-light/20 mt-4">
        <h2 className="font-ukir text-xl text-parchment mb-2">{kedaiProfile.name}</h2>
        <p className="font-jakarta text-wood-light text-xs max-w-xs mx-auto">{kedaiProfile.address}</p>
        <a
          href={kedaiProfile.mapsUrl}
          target="_blank"
          rel="noreferrer"
          className="inline-block mt-2 text-batik-gold font-jakarta text-xs underline underline-offset-2"
        >
          📍 Lihat di Google Maps
        </a>
        <div className="flex justify-center gap-4 mt-3 font-jakarta text-xs text-wood-light">
          <a
            href={`https://instagram.com/${kedaiProfile.instagram.replace(/^@/, "")}`}
            target="_blank"
            rel="noreferrer"
            className="hover:text-batik-gold"
          >
            📷 {kedaiProfile.instagram}
          </a>
          <a
            href={`https://tiktok.com/${kedaiProfile.tiktok.replace(/^@/, "@")}`}
            target="_blank"
            rel="noreferrer"
            className="hover:text-batik-gold"
          >
